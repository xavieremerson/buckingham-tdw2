...
function getClientData()
{
  ...
  var url = 'http://192.168.20.63/tdw/client_master_ajx.php';
  var pars = 'user_id=<?=$user_id?>';
  pars = pars + '&mod_request=appr';
...
<table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0"> 
  <tr>
    ...
    <!----><iframe src="client_master_ajx.php?proc_user=<?=$user_id?>" class="iframestyle" id="content_area" scrolling="auto" width="100%" style="border-width:thin; margin-top:0px; margin-left:0px;" onload="resize_iframe()"></iframe>
