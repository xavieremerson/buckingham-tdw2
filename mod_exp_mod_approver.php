...
// Change "_blank" to something like "newWindow" to load all links in the same new window
	...
	var url = 'http://192.168.20.63/tdw/mod_exp_mod_approver_excel.php';
...
// Change "_blank" to something like "newWindow" to load all links in the same new window
	...
	var url = 'mod_exp_mod_approver_proc.php';
	var pars = 'user_id=<?=$user_id?>';
	var mytime= '&ms='+new Date().getTime();
	pars = pars + mytime;
  var ran_number= Math.random()*5; 
...
<tr>
	<td> 
	<iframe name="if_status" id="if_status" src="mod_exp_mod_approver_proc.php?user_id=<?=$user_id?>" height="800" width="100%" marginwidth="0" marginheight="0" scrolling="yes" frameborder="0"></iframe>
	</td>
</tr>
</table>
<?php
