...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++			 
		...
		$data_to_html_file .= '
			...
			while($row_trades = mysql_fetch_array($result_trades))
			{
				...
				xdebug("Trader Date : (".format_date_ymd_to_mdy($trade_date_to_process).")", round((single_val_returns($qry_pbd_buck)*100)/single_val_returns($qry_pbd_all),0)."%");	
			
				$data_to_html_file .=	'
											<tr>
												<td><br><br><font color="#000000" size="3" face="Courier"><strong>
												Percent BUCK Commission in BCM Trades<br>
												&nbsp;&nbsp;Trader Date : ('.format_date_ymd_to_mdy($trade_date_to_process).') = '.round((single_val_returns($qry_pbd_buck)*100)/single_val_returns($qry_pbd_all),0).'%<br>
