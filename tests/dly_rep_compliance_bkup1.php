...
<?
		...
		$data_to_html_file .= '
			...
			while($row_trades = mysql_fetch_array($result_trades))
			{
				...
				$data_to_html_file .=	'
											...
											<font color="#0000FF" size="3" face="Courier"><strong>Blue: Employee Trades.</strong><br></font>
	...
	$file_name = $trade_date_to_process."_dly_dcar.html";     
	$file_pdf_name = $trade_date_to_process."_dly_dcar.pdf";     
