				...
				<!-- START TABLE 3 -->
					<table width="100%" cellpadding="1", cellspacing="0" bgcolor="#CCCCCC">
                        ...
                        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
                          ...
                          <tr bgcolor="#333333"> 
                            <td width="240"><a class="tblhead_a">&nbsp;&nbsp;&nbsp;&nbsp;ADVISOR / CLIENT</a></td>
                            ...
                            <td>&nbsp;</td>
													...
													$qry_relevant_primary_clients = "SELECT DISTINCT (a.clnt_code) as relevant_primary_client
																														...
																														AND b.ID = '".$user_id."'";
													//xdebug("Currently Testing Gault Issue", $qry_relevant_primary_clients);
													...
													while($row_level_a_adv = mysql_fetch_array($result_level_a_adv))
													{
														...
														$qry_multiple_rep = "SELECT distinct(concat(comm_advisor_code,'^',comm_rr)) as advisor_rep
																									...
																									AND comm_ytd > 0
																									AND comm_trade_date = ( 
																									SELECT max( comm_trade_date ) 
																									FROM mry_comm_rr_level_a
																									WHERE comm_advisor_code = '".$comm_advisor_code."' ) 
																									ORDER BY comm_rr";
														//Billy Gault was getting dupes because of inconsistent data in mry_comm_rr_level_a
														//due to cancel/correct data in mry_comm_rr_level_a FIXED ABOVE																								
																									
														
														//xdebug("Currently Testing", $qry_multiple_rep);
