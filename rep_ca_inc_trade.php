			...
			$query_trades = "SELECT 
													...
													sum(trad_quantity) as val_quantity,
      ...
      $query_shared_rep_trades = "SELECT 
																...
																sum(a.trad_quantity) as val_quantity,
			...
			?>
				<table width="100%" cellpadding="1", cellspacing="0" bgcolor="#CCCCCC">
					<tr>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#FFFFFF">				
							<tr>
									<td align="left"><a class="links_temp" href="rep_ca_exp_trade_excel.php?xl=<?=$passtoexcel?>" target="_blank"><img src="images\lf_v1\exp2excel.png" border="0"></a></td>
								</tr>
						</table>
			...
			<tr>
				...
				if ($row_trades["trad_advisor_name"] == '') {
					...
					$show_trad_advisor_name = $row_trades["trad_advisor_name"];
							  ...
							  $str_cents_per_share = round(($row_trades["for_sum_trad_commission"]/$row_trades["val_quantity"]),3);
							...
							while($row_shared_rep_trades = mysql_fetch_array($result_shared_rep_trades))
							{
								...
								if (in_array($row_shared_rep_trades["trad_symbol"],$arr_cu)) {
								$int_in_cu = 1;
								} else {
								$int_in_cu = 0;
								}
								
								echo 'dt ['.$count_row_trades.'] = "'.$row_shared_rep_trades["trad_trade_date"].'^'.
																													$show_trad_advisor_name.'^'.
