...
?>
		...
		<table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0">
			<tr> 
				...
				<br>
				TDW Admin</a></center>";*/
				if ($user_id != 79 and $user_id != 93 and $user_id != 253 and $user_id != 302 and $user_id != 403) { //
				echo "<center><br><br><br><a class='ilt'>You do not have appropriate access privilege to this module.
				<br>Please contact Technical Support for access privileges.
				<br>
				Thank You.
				<br>
				TDW Admin</a></center>";				
				} else {				
				include('pay_ndetl_sdate_config.php');
				}
				?>
				</td>
			</tr>
