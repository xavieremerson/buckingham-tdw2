...
//** - Support for multipart/alternative messages. 
//** - Ability to create attachments manually using literal content. 
...
//** the unique X-Mailer identifier for emails sent with this tool. 
  ...
  define("EmailXMailer", "CenterSys Group, Inc. : EMAILER v 2.0"); 
