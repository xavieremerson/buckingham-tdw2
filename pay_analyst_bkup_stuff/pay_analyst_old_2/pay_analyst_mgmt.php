...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <div id="scrollGrid_1">
			<table class="tbl_xl" border="0" cellpadding="0" cellspacing="0">
				...
				foreach ($arr_clnt_for_rr as $k=>$v) {
				?>
					<td class="tdx" valign="top"><a class="pplname"><?=$v?></a></td>
				<?
				$ccount++;
				}
				?>
				...
				<tr>
					...
					<td class="tdx">
						<table width="100%">
							<tr>
								<td><input type="text" style="border: 0px;" name="<?=$i."|".$j?>" id="<?=$i."|".$j?>" value="<?=$pop_array[$i."|".$j]?>" size="3" maxlength="3" onchange="xlrecalc('<?=$i."|".$j?>')" onkeyup="return xlmove(event, '<?=$i."|".$j?>')" /><!--<a class="num_1">% </a>--></td>
		...
		<!-- SUMMARY SECTION -->
			<table class="tbl_xl" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td width="1"><img src="images/spacer.gif" width="1" height="71" /></td>
					<td colspan="3" class="tdx" valign="middle" nowrap="nowrap"><h1>SUMMARY&nbsp;&nbsp;&nbsp;</h1></td></tr>
				<tr>
					<td width="1"><img src="images/spacer.gif" width="1" height="25" /></td>
	...
	<tr>
		<td colspan="3" valign="middle"><br />
				...
				<input type="image" src="images/btn_save_1.png"/>
				<img src="images/spacer.gif" width="10" height="1" />
				<input type="image" src="images/btn_finalize.png"/>
		</td>
	</tr>
</table>
