...
////SECTION: WHAT DAY TO PROCESS? 
	...
	$trade_date_to_process = '2009-04-17'; 
...
////SECTION: Create array of stocks in BCM WatchList for lookup
	$qry_bcm = "SELECT DISTINCT (bcm_cusip) as bcm_val
											FROM bcm_watchlist 
											WHERE 
												(bcm_datetime_stop > '".$trade_date_to_process." 00:00:00' AND '".$trade_date_to_process." 00:00:00' > bcm_datetime_start)
													OR 
												('".$trade_date_to_process." 00:00:00' > bcm_datetime_start AND bcm_datetime_stop = '2099-12-31')";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   //********************************************************************************************************
	 ...
	 //updated on 2010-May-04 to only get data which is upto the date in question.
	 $val_next_day = date('Y-m-d',strtotime($trade_date_to_process) + 86400);
	 $arr_mri_alt = array();
	 $result_alt = mysql_query("select * from _jovus_migration_mri where mri_date < '".$val_next_day."'"); 
	 //echo "select * from _jovus_migration_mri where mri_date < '".$val_next_day."'";
	 //exit;
