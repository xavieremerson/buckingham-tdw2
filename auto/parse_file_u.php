<?php
	...
	//**************************************************************************************
	// PREREQUISITE: File to be parsed is available at a location which is accessible to the
	// server running the parser.
	//
	// This file initiates the parsing process which involves the following steps
	// 1. Open file to read/parse
	// 2. Parse and put data in a temporary table
	// 3. Read from temporary table and put into production table
	//
	//
	//
	//
