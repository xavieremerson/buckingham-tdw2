...
*/
	...
	echo "trade_date_to_process in nameadd_u_delta = [".$trade_date_to_process."]\n";

   	
	//Empty the trad_nfs_delta_raw table
	$_query_empty = "TRUNCATE TABLE nfs_delta_nadd_101";
  ...
  //Upload/Parse file TRADREV.TXT
    ...
    echo "Processing file NAMED.DAT\n<br>";
  
  $row = 1;
	$name_add_row = 0;
	$fp = fopen ($download_location.$trade_date_to_process."\\NAMED.DAT", "r"); 
	while (!feof ($fp)) { 
...
$str_sql = "INSERT into nfs_delta_nadd_101 (
nadd_firm,
nadd_branch,
nadd_account_number,
nadd_num_confirms,
...
"'".trim($nadd_birth_date_shadow)."')";
				...
				//echo "Rows inserted : " . ($name_add_row + 1) ."\n";	
...
//Empty the nfs_delta_nadd table
$_query_empty_nfs_delta_nadd = "TRUNCATE TABLE nfs_delta_nadd";
$_result_empty_nfs_delta_nadd = mysql_query($_query_empty_nfs_delta_nadd) or die(mysql_error());

//temporary procedure to populate main nadd
$str_pop_nadd = "INSERT into nfs_delta_nadd (
nadd_firm,
nadd_branch,
nadd_account_number,
...
nadd_address_line_4,
nadd_address_line_5,
nadd_address_line_6 from nfs_delta_nadd_101";

	//echo $str_pop_nadd."\n\n";
	$result = mysql_query($str_pop_nadd) or die(mysql_error());	 
	 
	echo "Main tables populated.\n";
	
	$result1 = mysql_query("UPDATE nfs_delta_nadd set nadd_advisor = substring(nadd_short_name,1,4) where nadd_branch='PDY'") or die(mysql_error());	 
	$result2 = mysql_query("UPDATE nfs_delta_nadd set nadd_advisor = nadd_short_name where nadd_branch !='PDY'") or die(mysql_error());	 
?>