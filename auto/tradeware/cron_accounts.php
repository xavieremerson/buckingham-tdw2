...
//$trade_date_to_process = '2010-11-26';

ydebug('trade_date_to_process',$trade_date_to_process);

$filename_suffix_Ymd = date('Ymd',strtotime(business_day_forward(strtotime($trade_date_to_process),1)));
$filename_suffix_mdY = date('mdY',strtotime(business_day_forward(strtotime($trade_date_to_process),1)));

ydebug('filename_suffix',$filename_suffix);
...
echo "Processing begins.... file NAMED.DAT found.\n<br>";
							...
							//Removed this after discontinuing DOS March 2010
							...
							$output_filename = "ADD_FILE_".$filename_suffix_Ymd.".txt"; //date('Ymd')
							$fp = fopen($output_filename, "w");
							
							//Header
							$string = "BUCKCAP   ".$filename_suffix_mdY."  ". date("His").str_pad("",22," ",1)."NAME AND ADDRESS ADD FILE"."\n"; //."<br>" //date("mdY")
							fputs ($fp, $string);
							...
							$output_filename = "CHANGE_FILE_".$filename_suffix_Ymd.".txt"; //date('Ymd')
							$fp = fopen($output_filename, "w");
							
							//Header
							$string = "BUCKCAP   ".$filename_suffix_mdY."  ". date("His").str_pad("",22," ",1)."NAME AND ADDRESS CHANGE FILE"."\n"; //."<br>"//date("mdY")
							fputs ($fp, $string);
							...
							fputs ($fp, "put ".$tdw_local_location."auto\\tradeware\\"."CHANGE_FILE_".$filename_suffix_Ymd.".txt"."\r\n"); //date('Ymd')
							fputs ($fp, "put ".$tdw_local_location."auto\\tradeware\\"."ADD_FILE_".$filename_suffix_Ymd.".txt"."\r\n"); //date('Ymd')
							fputs ($fp, "pwd"."\r\n");
							//fputs ($fp, "ls"."\r\n");
							fclose($fp);
							...
							if ($alert_email == 1) {
								...
								$subject = "TDW Alert: Missing TRADEWARE Code for Account Upload (".date('m-d-Y').")";
								$text_body = $subject;
