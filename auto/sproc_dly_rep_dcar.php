...
//====================================================================================================
	...
	//$trade_date_to_process = '2006-11-30';
...
$msdb=mssql_select_db("BuckinghamTwo",$msconnect);
  ...
  //Most recent research date from Jovus
		...
		$ms_qry_rres   = "SELECT 
											...
											AND ((dbo.Products.CreationDateTime) <  CAST(FLOOR(CAST(getdate() AS float)) as datetime))
											...
											//removed dbo.Issuers.CUSIP <> '' after Jovus Migration
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //Most recent MRI Date
		...
		$ms_qry_mri = "SELECT 
										...
										INNER JOIN dbo.Prod_Statuses ON dbo.Products.ProductID = dbo.Prod_Statuses.ProductID
										INNER JOIN dbo.ExchangeSecurities ON dbo.Issuers.IssuerID = dbo.ExchangeSecurities.SecurityID
										WHERE (((dbo.ExchangeSecurities.Ticker <> '') AND (dbo.Products.CreationDateTime BETWEEN (GETDATE()-180) AND CAST(FLOOR(CAST(getdate() AS float)) as datetime)) 
...
//show_array($arr_acct_emp);
							...
							//processed in a separate section at the end of segment	
  							...
  							$result_trades = mysql_query($query_trades) or die(tdw_mysql_error($query_trades));
								...
								while($row_trades = mysql_fetch_array($result_trades))
								{
									...
									//echo "Not processed =".$comm_account_number."<br>";  //tmp_mry_cmpl_temp
									} else {
       ...
       //combine two arrays (this creates a new index)
			 ...
			 $merged_array_trades = array_merge($arr_oemp_trades_to_merge, $arr_nfs_trades_to_merge);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++			
  ...
  //test
	$file_name = $trade_date_to_process."_dcar.html";    //_testnew
	$file_pdf_name = $trade_date_to_process."_dcar.pdf"; //_testnew
...
//production
$arr_recipient[0] = 'tsutera@buckresearch.com';
$arr_recipient[1] = 'pprasad@centersys.com';
