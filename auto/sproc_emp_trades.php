...
for ($bizdays=1; $bizdays < 300; $bizdays++) {
			...
			if (strtotime(business_day_forward(strtotime("2006-12-21"),$bizdays)) > strtotime("now")) {
				echo business_day_forward(strtotime("2006-12-21"),$bizdays)."<br>";
				echo "Exit condition met... Program exiting normally<br>";
				
			} else {

							$trade_date_to_process = business_day_forward(strtotime("2006-12-21"),$bizdays);
