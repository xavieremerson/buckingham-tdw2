...
echo "Trade date obtained from previous file = ".$trade_date_to_process ."\n\n";
...
//Now the above information is obtained from the including page.
							...
							echo "mry_comm_rr is flushed and ready for the next set of data\n\n";
                  ...
                  if ($comm_cents_per_share > 10) {
                      ...
                      xdebug("Processsing Rep: ",$row_rr["comm_rr"]);											
							...
							while($row_cancelled_trades = mysql_fetch_array($result_cancelled_trades))
							{
								...
								{
									//echo "INFO: Reference Number [".$row_get_original_trade["trad_trade_reference_number"]."], Original Trade Date: [".$row_get_original_trade["trad_trade_date"]."], and cancelled on [".$trade_date_to_process."]\n\n";
									//Tables impacted
								 	//rep_comm_rr_trades
									//rep_comm_rr_level_b 
									//rep_comm_rr_level_a 
