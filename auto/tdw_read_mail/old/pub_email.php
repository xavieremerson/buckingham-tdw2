...
<a:searchrequest xmlns:a=\'DAV:\'>
 <a:sql>
	SELECT "DAV:href","urn:schemas:httpmail:subject","urn:schemas:httpmail:date"
		FROM scope(\'shallow traversal of "'.$exchange_server.'/exchange/'.$exchange_username.'/Inbox"\')
...
<a:searchrequest xmlns:a="DAV:" xmlns:s="http://schemas.microsoft.com/exchange/security/"> 
   <a:sql> 
       ...
       FROM "'.$exchange_server.'/Exchange/'.$exchange_username.'/inbox" 
   </a:sql> 
</a:searchrequest>'; 
...
if (!$h->fetch($exchange_server."/Exchange/".$exchange_username."/inbox", 0, null, $exchange_username, $exchange_password, "SEARCH")) { 
