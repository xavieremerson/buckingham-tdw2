...
echo $row_staging['trad_settle_date'];

 $query_main = "INSERT INTO nfs_trades(
trad_firm,
trad_buy_sell,
trad_trade_date,
trad_settle_date,
...
"'".$row_staging['trad_sec_desc_1']."',".
"'".$row_staging['trad_sec_desc_2']."',".
"'".$row_staging['trad_sec_desc_3']."',".
"'".$row_staging['trad_sec_desc_4']."',".
"'".$row_staging['trad_sec_desc_5']."',".
"'".$row_staging['trad_sec_desc_6']."',".
"'".$row_staging['trad_sec_desc_7']."',".
"'".$row_staging['trad_sec_desc_8']."',".
"'".$row_staging['trad_sec_desc_9']."',".
...
"'".substr($row_staging['trad_additional_markup'],0,9).".".substr($row_staging['trad_additional_markup'],9,1)."',".
...
"'".$row_staging['trad_super_branch']."')";
 ...
 //echo $query_main . "<br><br>";
 xdebug('trad_alphaprice_fraction',$row_staging['trad_alphaprice_fraction']);
 xdebug('length of alpha...',strlen($row_staging['trad_alphaprice_fraction']));
  $result_main = mysql_query($query_main) or die (mysql_error());
  echo "Rows inserted: ".$row_inserted."<br>";
