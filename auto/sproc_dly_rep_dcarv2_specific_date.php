...
////
// Function to return an array of mri data for a specific ticker
function return_arr_mri ($symbol, $arr_mri) {
  $arr_subset_mri = array();
	foreach ($arr_mri as $k=>$v) {
		$arr_data = explode("<###>",$v);
		$val_symbol = $arr_data[0];
		if ($val_symbol == $symbol) {
				$arr_subset_mri[$k] = $v;
		}
	}
	return $arr_subset_mri;
}
...
////SECTION: WHAT DAY TO PROCESS? 
	...
	$trade_date_to_process = '2010-01-20';
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   //exit;
	 ...
	 //create a list of symbols in MRI
	 $arr_recent_mri_symbols = array();
	 foreach($arr_mri as $key=>$value) {
		 $arr_data = explode("<###>",$value);
		 $str_x_symbol = $arr_data[0];
		 $arr_recent_mri_symbols[$str_x_symbol] = $str_x_symbol;
	 }	
	 //show_array($arr_recent_mri_symbols); 
