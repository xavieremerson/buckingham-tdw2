...
for ($bizdays=1; $bizdays < 200; $bizdays++) {
			...
			if (strtotime(business_day_forward(strtotime("2007-06-30"),$bizdays)) > strtotime("now")) {
				echo business_day_forward(strtotime("2007-06-30"),$bizdays)."<br>";
				echo "Exit condition met... Program exiting normally<br>";
				
			} else {

							$trade_date_to_process = business_day_forward(strtotime("2007-06-30"),$bizdays);
							...
							//$trade_date_to_process = '2007-10-31';
						...
						//test
							...
							$file_name = $trade_date_to_process . "_testnew.html";    //   _dcarv2
							$file_pdf_name = $trade_date_to_process . "_testnew.pdf"; // _dcarv2
						...
						*/
						...
						include('sproc_dly_rep_dcarv2_lookback_BULK.php');
			}
}
?>