...
////SECTION: WHAT DAY TO PROCESS?
	...
	$trade_date_to_process = '2009-03-19';
...
////SECTION: Create array of stocks in BCM WatchList for lookup
	$qry_bcm = "SELECT DISTINCT (bcm_cusip) as bcm_val
											FROM bcm_watchlist 
											WHERE 
											(bcm_datetime_stop > '".$trade_date_to_process." 00:00:00'
											  AND
											 bcm_datetime_stop < '".business_day_forward(strtotime($trade_date_to_process), 1)." 00:00:00')
											OR 
											(bcm_datetime_start <'".business_day_forward(strtotime($trade_date_to_process), 1)." 00:00:00' AND bcm_datetime_stop = '2099-12-31')";
