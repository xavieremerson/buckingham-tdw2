...
//====================================================================================================
	...
	$trade_date_to_process = '2008-09-08';
  ...
  //Create array of analysts/stocks in coverage universe for lookup
	...
	$qry_oth_trades = "SELECT auto_id,
										...
										ORDER BY oth_symbol";
	xdebug("qry_oth_trades",$qry_oth_trades);
...
//test
	...
	$file_name = $trade_date_to_process."_dcarv2_jess.html";    //_testnew   
	$file_pdf_name = $trade_date_to_process."_dcarv2_jess.pdf"; //_testnew 
