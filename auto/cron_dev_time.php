...
//$trade_date_to_process = '2006-01-17';
$trade_date_to_process = '2006-08-16';
ydebug('trade_date_to_process',$trade_date_to_process);

for ($bizdays=1; $bizdays < 5; $bizdays++) {

			if (strtotime(business_day_forward(strtotime("2006-08-16"),$bizdays+1)) > strtotime("now")) {
				echo business_day_forward(strtotime("2006-08-16"),$bizdays)."<br>";
				echo "Exit condition met... Program exiting normally<br>";
				exit;
			} else {
							$trade_date_to_process = business_day_forward(strtotime("2006-08-16"),$bizdays);
							ydebug('trade_date_to_process',$trade_date_to_process);
							//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//Not using this section (accounts) for the current tests
/*
