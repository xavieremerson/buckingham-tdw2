...
foreach ($arr_master as $indexval => $symbol_val) {
								...
								//http://finance.yahoo.com/q/in?s=FRX
								 ...
								 $str_whole = "";
									...
									$fd = fopen ("http://finance.yahoo.com/q/in?s=".$symbol_val, "r");
										while (!feof ($fd)) 
											{
								 ...
								 //exit;
									...
									echo "Sector: ".$all_table_data[0][1]."\n";
									echo "Industry ".$all_table_data[1][1]."\n";
									
									$sector = str_replace("&amp;", "&", $all_table_data[0][1]);
									$industry = str_replace("&amp;", "&", $all_table_data[1][1]);
