...
include('../includes/functions.php'); 
	...
	$trade_date_to_process = '2005-06-09';
  ...
  //Upload/Parse file TRADREV.TXT
    ...
    echo "Processing file TRADREV.TXT\n<br>";
  	...
  	$row = 1;
	$traderow = 0;
	$fp = fopen ($download_location."2006-01-18\\TRDREV_TD.DAT", "r"); 
	while (!feof ($fp)) { 
		...
		//xdebug("recnum",$recnum);
			if ($recnum == "01") {
				...
				//xdebug("trad_trade_date",$trad_trade_date);
				//xdebug("trad_settle_date",$trad_settle_date);
				...
				xdebug("trad_trade_reference_number",$trad_trade_reference_number);
				...
				//xdebug("trad_minor_clearing_broker",$trad_minor_clearing_broker);
				...
				xdebug("trad_alphaprice_fraction",$trad_alphaprice_fraction);
				...
				//xdebug("trad_yield_date",$trad_yield_date);
				...
				xdebug("trad_solicited_code",$trad_solicited_code);
				...
				xdebug("trad_confirm_legend_code",$trad_confirm_legend_code);
...
"'".trim($trad_sec_desc_1)."',".
"'".trim($trad_sec_desc_2)."',".
"'".trim($trad_sec_desc_3)."',".
"'".trim($trad_sec_desc_4)."',".
"'".trim($trad_sec_desc_5)."',".
"'".trim($trad_sec_desc_6)."',".
"'".trim($trad_sec_desc_7)."',".
"'".trim($trad_sec_desc_8)."',".
"'".trim($trad_sec_desc_9)."',".
"'".trim($trad_confirm_legend_code)."',".
...
"'".trim($trad_super_branch)."')";
				...
				echo "Rows inserted : " . ($traderow + 1) ."<br><br><br>";	
				$traderow = $traderow + 1;
			}
			else {
