...
<!-- <body onLoad="setFocus('val1'); showDetail('');">
 -->
<?
table_start_percent("100%", "Data Entry: Other Revenues");
?>
<form name="de_comm">
<table width="400" border="1" cellspacing="0" cellpadding="4">
  <tr>
    <td width="60">input1</td>
    <td width="334"><input name="val1" type="text" size="30" maxlength="30" TABINDEX=1 onKeyPress="return bar(event, 'val2')"></td>
  </tr>
  <tr>
    <td>input2</td>
    <td><input name="val2" type="text" size="30" maxlength="30" TABINDEX=2 onKeyPress="return bar(event, 'val3')"></td>
  </tr>
  <tr>
    <td>input3</td>
    <td><input name="val3" type="text" size="30" maxlength="30" TABINDEX=3 onKeyPress="return bar(event, 'Submit')"></td>
  </tr>
  <tr>
    <td></td>
    <td><input name="Submit" type="button" TABINDEX=4 onClick="getFormValues()" value="SAVE"></td>
  </tr>
</table>
</form>
<?
