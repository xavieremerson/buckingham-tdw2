												...
												<table width="100%" cellpadding="1", cellspacing="0" >
													<tr>
														...
														<table width="100%"  border="0" cellspacing="1" cellpadding="0">
															<tr>
																<td width="260">&nbsp;&nbsp;<strong>CLIENTS (PRIMARY)</strong></td>
													 ...
													 $str_excel .= '
														...
														<table width="100%"  border="0" cellspacing="1" cellpadding="0">
															 <tr class="display_totals"> 
																<td width="260" align="left">&nbsp;&nbsp;<strong>TOTALS:</strong></td>
																<td width="40">&nbsp;&nbsp;</td>
																...
																<td width="80" align="right"><strong>'.show_numbers($total_grand_ytd_ly).'</strong></td>
																<td width="50" align="right"><strong>'.number_format(($total_grand_ytd/$total_grand_ytd_ly)*100,0,"",",").'</strong></td>
																<td>&nbsp;</td>                          
															</tr>
														</table>
													</td>
											...
											<br>
												<table width="100%" cellpadding="1", cellspacing="0" >
													<tr>
														...
														<table width="100%"  border="0" cellspacing="1" cellpadding="0">
															<tr> 
																<td colspan="2" width="260" nowrap="nowrap">&nbsp;&nbsp;<strong>"Brokerage Month Basis"</strong></td>
																<td colspan="4" align="center"><strong>C O M M I S S I O N S</strong></td>
																<td colspan="3" align="center"><strong>CHECKS</strong> <font color="red"><strong>(Cal. Mth.)</strong></font></td>
																<td colspan="3" align="center"><strong>T O T A L</strong></td>
																<td align="center"><strong>LAST YEAR</strong></td>
																<td align="center"><strong>%</strong></td>
																<td >&nbsp;</td>
															<tr ><b>
																<td width="260">&nbsp;&nbsp;<strong>CLIENTS (SHARED)</strong></td>
																<td width="40">&nbsp;&nbsp;<strong>RR</strong></td>
																<td width="70" align="right"><strong>'.substr(format_date_ymd_to_mdy($trade_date_to_process),0,5).'</strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>MTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>QTD</strong>&nbsp;&nbsp;</td>
																<td width="80" align="right"><strong>YTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>MTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>QTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>YTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>MTD</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>QTD</strong>&nbsp;&nbsp;</td>
																<td width="80" align="right"><strong>YTD</strong>&nbsp;&nbsp;</td>
													  ...
													  $str_excel .= '
														...
														<table width="100%"  border="0" cellspacing="1" cellpadding="0">
															 <tr> 
																<td width="260" align="left">&nbsp;&nbsp;<strong>TOTALS:</strong></td>
																<td width="40">&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_pbd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_mtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_qtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="80" align="right"><strong>'.show_numbers($total_ytd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_cmtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_cqtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_cytd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_grand_mtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="70" align="right"><strong>'.show_numbers($total_grand_qtd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="80" align="right"><strong>'.show_numbers($total_grand_ytd_shrd).'</strong>&nbsp;&nbsp;</td>
																<td width="80" align="right"><strong>'.show_numbers($total_grand_ytd_shrd_ly).'</strong>&nbsp;&nbsp;</td>
																<td width="50" align="right"><strong>'.number_format(($total_grand_ytd_shrd/$total_grand_ytd_shrd_ly)*100,0,"",",").'</strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>
																<td>&nbsp;</td>                          
															</tr>
														</table>
													</td>
