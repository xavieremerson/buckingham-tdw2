...
<!-- class="tablewithdata" -->
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1"> 
			 <tr class="display_totals"> 
				<td width="344" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTALS:</td>
				<td width="102" align="right"><?=number_format($running_total_comm,2,'.',",")?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="104" align="right"><?=number_format($running_total_mtd,2,'.',",")?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="104">&nbsp;</td>
				<td width="102" align="right"><?=number_format($running_total_qtd,2,'.',",")?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="104">&nbsp;</td>
				<td width="104" align="right"><?=number_format($running_total_ytd,2,'.',",")?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="100">&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
		</table>
