													...
													<tr>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																...
																<td width="100"><a href="rep_all_trdr_ca_container.php"><img src="images/lf_v1/clnt_activity.png" border="0"></a></td>
															</tr>
														</table>
														</td>   
													</tr> 
													...
													while($row_adv_checks = mysql_fetch_array($result_adv_checks))
															{
																...
																if ($process_advisor == 'SEAR') {
																xdebug("query_get_adv_checks",$query_get_adv_checks);
																}
                        ...
                        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
							...
							<tr id="pbd"> <!--  style="display=none; visibility=hidden" -->
								<td>
									<br>
									<?
									include('rep_xmtrdr2y_inc_trade.php');
									?>
								</td>
							</tr>
						</table>
