																				...
																				while ($row_pid = mssql_fetch_array($ms_results_pid)) {
																						...
																						$next_year = 'NO EST';
																								...
																								if ($arr_vals_year_qtr[1] < 4) {
																												$ms_qry_relevant_vals = 	"SELECT Q".$arr_vals_year_qtr[1]."Value, Q".($arr_vals_year_qtr[1]+1)."Value, FinancialValue
																												...
																												$ms_qry_relevant_vals_more = 	"SELECT FinancialValue
																																												FROM dbo.Prod_FinancialValues
																																												WHERE IssuerID = '".$row_rres[0]."'
																																												AND ProductID = '".$row_pid[0]."'
																																												AND FinancialType = 'EPS'
																												...
																												$ms_qry_relevant_vals = 	"SELECT Q".$arr_vals_year_qtr[1]."Value, FinancialValue
																																										FROM dbo.Prod_FinancialValues
																																										WHERE IssuerID = '".$row_rres[0]."'
																																										AND ProductID = '".$row_pid[0]."'
																																										AND FinancialType = 'EPS'
																												...
																												$ms_qry_relevant_vals_more = 	"SELECT Q1Value, FinancialValue
																																												FROM dbo.Prod_FinancialValues
																																												WHERE IssuerID = '".$row_rres[0]."'
																																												AND ProductID = '".$row_pid[0]."'
																																												AND FinancialType = 'EPS'
