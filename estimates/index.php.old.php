...
<table width="600" border="0" cellspacing="0" cellpadding="10">
  ...
  <tr>
    <td colspan="2">
			...
			It may take anywhere from 4 to 10 minutes to complete processing. After completion, 
									 ...
									 //exit;
										...
										?>
													  ...
													  $val_curr_qtr = "";
														...
														xdebug("curr_qtr",$curr_qtr);
														xdebug("next_qtr",$next_qtr);
														xdebug("curr_year",$curr_year);
														xdebug("next_year",$next_year);
