...
<table cellpadding="0" cellspacing="0" width="900" border="1" >
  <tr>
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&													
												...
												<tr>
													...
													<td width="100"><? if (trim($curr_qtr) == '' or $curr_qtr == 'NO EST' or $curr_qtr == NULL ) {echo "NO EST"; } else { echo $curr_qtr; }?></td>
													<td width="100"><? if (trim($next_qtr) == '' or $next_qtr == 'NO EST' or $next_qtr == NULL ) {echo "NO EST"; } else { echo $next_qtr; }?></td>
													<td width="100"><? if (trim($curr_year) == '' or $curr_year == 'NO EST' or $curr_year == NULL) {echo "NO EST"; } else { echo $curr_year; }?></td>
													<td width="100"><? if (trim($next_year) == '' or $next_year == 'NO EST' or $next_year == NULL) {echo "NO EST"; } else { echo $next_year; }?></td>
