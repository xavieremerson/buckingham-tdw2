...
function process_excel () {
  ...
  var url = 'http://192.168.20.63/tdw/rep_compliance_notes_export_excel.php';
  var pars = 'user_id=<?=$user_id?>';
  pars = pars + '&iddatefrom='+$("iddatefrom").value;
  pars = pars + '&iddateto='+$("iddateto").value;
...
$qry_rept = "select auto_id 
							...
							where msrv_trade_date > '2008-12-31'
...
<? tsp(100, "Compliance Review Log"); ?>
														...
														<form name="clnt_activity" id="idclnt_activity" action="" method="get">
															<tr>
																...
																<td width="200" nowrap="nowrap" align="center"><a class="ilt" href="javascript:process_excel();">Export to Excel</a></td>
																<td>&nbsp;</td>
															</tr>
														</form>			
														</table>
