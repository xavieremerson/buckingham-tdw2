...
$percent_payout_comm = 20; //temporarily put here for value
...
$xlfilename = $arr_months_longnames[$brk_month]."-".$brk_year."_".date('mdY').".xls"; //."__".substr(md5(rand(1000000000,9999999999)),0,5)
//$xlfilename = "test.xls";
$wkb = new Spreadsheet_Excel_Writer('data/xls/'.$xlfilename);

	//FORMATTING IN THE FOLLOWING FILE
	include('mrr_gen_excel_format.php');

	$wks =& $wkb->addWorksheet("Payout Summary");
	//$wks->setLandscape ();
	$wks->setPortrait ();
	$wks->setMarginLeft(1.0);
