							...
							<td valign="top"> 
                                ...
                                <td width="30" align="left"><input type="image" src="images/lf_v1/form_submit.png" border="0"></td>
																...
																function go_prntscrn () {
																 document.prntscrn.sel_rep.value = <?=$rep_id?>;
																 ...
																 document.prntscrn.info_str.value = '<?=$userfullname?>';
																	...
																	<form name="prntscrn" action="sales_rev_rep_summ_excel.php" method="get" target="_blank">
                                ...
                                <td width="5">&nbsp;</td>
																...
																function go_excel_detail () {
																 document.exceldetail.sel_rep.value = <?=$rep_id?>;
																 ...
																 document.exceldetail.info_str.value = '<?=$userfullname?>';
																	...
																	<form name="exceldetail" action="sales_rev_rep_summ_excel_detail.php" method="get" target="_blank">
	...
	foreach ($arr_reps_list_array_final as $use_rep_id=>$cv) {
		foreach($arr_sole_joint as $dk=>$dv) {
			foreach($arr_tier_val as $ek=>$i) {
              ...
              <td colspan="19" height="0" bgcolor="#FFFFFF" id="div_<?=$id_md5?>" style="visibility:hidden; display:none;"></td>
              </tr>
							<?
              $level_a_count++;
				}
