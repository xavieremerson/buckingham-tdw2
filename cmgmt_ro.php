...
?>
    ...
    <td width="650">
		...
		echo '<a class="links11" href="cmgmt_ro.php?type=manage&strltr='.$str_get_link.'"> '."[SHOW ALL]".' </a>&nbsp;';
		
		while ( $row = mysql_fetch_array($result) )	{
			echo '<a class="links11" href="cmgmt_ro.php?type=manage&strltr='.$row["strltr"].$str_get_link.'"> '.$row["strltr"].' </a>&nbsp;';
		}
		?>
    </td>
					...
					<table>
						...
						<tr valign="top">
							<td colspan="2" align="center"><p>
								<a href="cmgmt_ro.php?type=manage" class="ilt">Go Back</a>&nbsp;&nbsp;&nbsp;&nbsp;<input class="Submit" type="submit" name="editClient" value="Update"></p>
							</td>
						</tr>  
					</table>
				</td>
