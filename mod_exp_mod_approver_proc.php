...
function process_appr()  //get requests of pre-approval from users.
{
	...
	var url = 'http://192.168.20.63/tdw/mod_exp_mod_approver_ajx.php';
            ...
            response = transport.responseText;  
						var responseLenght = response.length;
							...
							if (responseLenght > 0) {
								...
								parent.$("if_status").src= 'mod_exp_mod_approver_proc.php?user_id=<?=$user_id?>';
								//$("data_sec").innerHTML = "";
...
<a href="#" class="ilt" onclick="unchkall();" class="gilt">UnCheck All</a>
  <div id="divapprover">
    ...
    <input type="button" name="save" value="&nbsp;&nbsp;&nbsp;&nbsp;Approve / Proceed&nbsp;&nbsp;&nbsp;&nbsp;" onClick="process_appr();" />
    </form>
		</div>
