...
$male = array(215, 238, 225, 236, 235, 260, 286, 340, 363, 305, 259, 164, 135,
    127, 102, 68, 66);

#The female population (in thousands)
$female = array(194, 203, 201, 220, 228, 271, 339, 401, 384, 304, 236, 137, 116,
    122, 112, 85, 110);
...
$textObj = $c->addText(300, 0, "Female", "timesbi.ttf", 12, 0xa07070);
...
#produce the same scale for both chart.
$c->addLineLayer($female, Transparent);
