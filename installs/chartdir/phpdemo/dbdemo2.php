...
To run this example, you need to set up the database as mentioned in <a href="dbdemo1.php">
Database Integration Demo (1)</a>. After that, <a href="dbdemo2_main.php">click here</a> to run
this demo.<br><br>

If you just want to view the sample code, please use the links below:
<ul>
	<li><a href="viewsource.php?file=dbdemo2_main.php">View containing HTML page source code</a>
