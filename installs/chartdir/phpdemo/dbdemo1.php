...
The example demonstrates creating a chart using data from a database. This example is
...
<ul>
	...
	<li><a href="dbdemo1_main.php">Click here</a> to run this demo.
</ul>

If you just want to view the sample code, please use the links below:
<ul>
	<li><a href="viewsource.php?file=dbdemo1_main.php">View containing HTML page source code</a>
