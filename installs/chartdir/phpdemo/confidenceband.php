...
$c->addScatterLayer($dataX, $dataY, "", DiamondSymbol, 11, 0x8000);

#Add a trend line layer for (dataX, dataY)
$layer = $c->addTrendLayer2($dataX, $dataY, 0x8000);

#Set the line width to 3 pixels
$layer->setLineWidth(3);

#Add a 95% confidence band for the line
$layer->addConfidenceBand(0.95, 0x806666ff);

#Add a 95% confidence band (prediction band) for the points
$layer->addPredictionBand(0.95, 0x8066ff66);
...
$textbox = $c->addText(56, 65, sprintf(
    "<*block*>Slope\nIntercept\nCorrelation\nStd Error<*/*>   <*block*>%.4f ".
    "sec/tps\n%.4f sec\n%.4f\n%.4f sec<*/*>", $layer->getSlope(),
    $layer->getIntercept(), $layer->getCorrelation(), $layer->getStdError()),
    "arialbd.ttf", 8);
