<?
  ...
  include('includes/global.php'); 
	...
	$wkb = new Spreadsheet_Excel_Writer('data/exports/'.$xlfilename);
		...
		include('pay_analyst_adj_excel_header.php');
  ...
  //Print Totals Percentage Row
    ...
    //PRINT SUMMARY TABLE
		...
		foreach ($arr_analysts as $k=>$v) {
			$wks->writeFormula($xl_row, $xl_col+3, "=round((".$arr_xl_cols[$xl_col-1].($xl_row+1)."/".$arr_xl_cols[$xl_col+3]."2".")*100,1)", $format_title_2a);
			$xl_row = $xl_row + 1;
		}
