...
// Change "_blank" to something like "newWindow" to load all links in the same new window
	...
	var url = 'http://192.168.20.63/tdw/mod_exp_pdf.php';
...
<table width="100%" cellpadding="0" cellspacing="0">
  <form name="exp_criteria" id="exp_criteria" action="" method="post">
    <tr>
      ...
      <td width="10"><img src="images/lf_v1/exp2pdf.png" onclick="export_pdf();" style="cursor:pointer"/></td>
      <td>&nbsp;</td>
		</tr>
  </form>
</table>
...
<table>
	<tr>
      ...
      <table cellpadding="2">
        ...
        <tr>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_hotel_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_meals_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_phone_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_entertainment_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_misc_r"/></td>
          <td class="rilt"></td>
          <td></td>
        </tr>
      </table>
      ...
      <table>
        ...
        <tr>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_air_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_train_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_cab_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_rental_r"/></td>
          <td class="rilt">Rcpt.</td>
          <td><input type="checkbox" value="1" name="exp_mileage_r"/></td>
          <td class="rilt">Rcpt.</td> 
          <td><input type="checkbox" value="1" name="exp_other_r"/></td>
        </tr>
			</table>
      </fieldset>
      <!--<input type="checkbox" class="checkbox" style="size:30px" name="have_receipt" id="have_receipt" value="1"/>--><a class="lilt">Rcpt. Checkboxes above must be checked if you have receipts for the corresponding expenses.</a>
    </td> 
  </tr> 
</table>
