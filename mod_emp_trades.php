								...
								<!-- class="tablewithdata" -->
												<table width="100%" bgcolor="#FFFFFF">
													<tr>
														...
														<form name="clnt_activity" id="idclnt_activity" action="mod_emp_trades_container.php" method="post">
															<tr>
																<td width="10">&nbsp;</td>
																...
																?>
																<td width="80"><a href="mod_emp_trades_exp_trade_excel.php?xl=<?=$passtoexcel?>" target="_blank"><img src="images/lf_v1/exp2excel.png" border="0"></a></td>
																<td>&nbsp;</td>
														</tr>
														</form>															
														</table>
													...
													<tr id="pbd"> <!--  style="display=none; visibility=hidden" -->
														<td>
															<?
															include('mod_emp_trades_inc_trade.php');
															?>
														</td>
													</tr>
												</table>
