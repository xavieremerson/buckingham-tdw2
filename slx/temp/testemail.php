...
//** establish to,from, and any other recipiants. 
  ...
  $Sender = "prasad_pravin@yahoo.com"; 
  $Recipient = "prasad_pravin@yahoo.com"; 
  $Cc = "pprasad@centersysgroup.com"; 
  $Bcc = ""; 
...
//** create the new message using the to, from, and email subject. 
  ...
  $msg = new Email($Recipient, $Sender, "A Test Plain Text Email!"); 
  $msg->Cc = $Cc; 
  $msg->Bcc = $Bcc; 
...
//** create the new message using the to, from, and email subject. 
  ...
  $msg = new Email($Recipient, $Sender, "A Test HTML Email!"); 
  $msg->Cc = $Cc; 
  $msg->Bcc = $Bcc; 
