...
$format_title_2->setSize('8');
$format_title_2->setAlign('center');

$format_title_2a =& $wkb->addFormat();
$format_title_2a->setBold();
$format_title_2a->setPattern(0);
$format_title_2a->setFontFamily('Verdana'); 
$format_title_2a->setSize('9');
$format_title_2a->setAlign('right');

$format_title_2b =& $wkb->addFormat();
$format_title_2b->setBold();
$format_title_2b->setPattern(0);
$format_title_2b->setFontFamily('Verdana'); 
$format_title_2b->setSize('9');
$format_title_2b->setAlign('right');
$format_title_2b->setNumFormat('#,##0.0;(#,##0.0)');
...
$format_data_courier =& $wkb->addFormat();
$format_data_courier->setPattern(0);
$format_data_courier->setFontFamily('Courier'); 
$format_data_courier->setSize('10');
...
$format_currency_2a =& $wkb->addFormat();
$format_currency_2a->setPattern(0);
$format_currency_2a->setFontFamily('Arial'); 
$format_currency_2a->setSize('8');
$format_currency_2a->setColor('gray'); 
$format_currency_2a->setNumFormat('$#,##0.00;($#,##0.00)');
...
//format text bold right
$ftbr =& $wkb->addFormat();
$ftbr->setBold();
$ftbr->setPattern(0);
$ftbr->setFontFamily('Arial'); 
$ftbr->setSize('9');
$ftbr->setAlign('right');
