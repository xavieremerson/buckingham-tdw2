...
function adv_search() {
		var divid = 'adv_criteria';
		if (document.getElementById(divid).style.visibility == 'visible') {
		document.getElementById(divid).style.visibility = 'hidden'; 
		document.getElementById(divid).style.display = 'block';  //none
														...
														<form name="clnt_activity" id="idclnt_activity" action="" method="post">
															<tr>
																...
																<td width="205">
																		...
																		<input type='text' name="val_client" style='font-family:verdana;width:200px;font-size:11px' id='tb' value='Enter Client' onFocus="set_val_null('tb')" /> 
																		<script>
																...
																<td width="5">&nbsp;</td>
																<td width="150"><input type="image" src="images/lf_v1/form_submit.png"></td>
																<td width="10" align="center">&nbsp;</td>
																<td width="10" align="center">&nbsp;</td>
																<td>&nbsp;</td>
															</tr>
															<tr>
                              	<td width="120"><img src="images/btn_adv_search.png" onclick="adv_search()"></td>
                                <td colspan="19" align="left">
                                	<div id="adv_criteria" style="visibility:hidden">
                                	<table border="0" cellpadding="0" cellspacing="0"><tr>
                                  <td>
                                  &nbsp;&nbsp;
                                  <input type="checkbox" id="id_nfs" name="id_nfs" checked="checked" value="1" />&nbsp;
                                  <font class="ilt">NFS</font>&nbsp;&nbsp;
                                  </td>
                                  <td>
                                  <input type="checkbox" id="id_bcm" name="id_bcm" value="1" />&nbsp;
                                  <font class="ilt">BCM</font>&nbsp;&nbsp;
                                  </td>
                                  <td>
                                  <input type="checkbox" id="id_emp" name="id_emp" value="1" />&nbsp;
                                  <font class="ilt">Employee</font>&nbsp;&nbsp;
                                  </td>
                                  </tr>
                                  </table>
                                  </div>
													...
													<tr id="pbd"> <!--  style="display=none; visibility=hidden" -->
														<td>
														<?
														include('activity_inc_trade.php');	
														?>
														</td>
													</tr>
												</table>
