...
$str_status .= '<p class="ilt">Following is the preformatting for printing the Summary Report<br />
- LEGAL<br />
- Landscape<br />
...
Report generated in '. sprintf("%01.2f",((getmicrotime()-$time)/1000)).' s.';
