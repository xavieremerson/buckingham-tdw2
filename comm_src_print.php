...
include('comm_src_inc_main.php');
		...
		$data_to_html_file .= '
														...
														<table width="100%"  border="0" cellspacing="1" cellpadding="0">
															...
															if ($show_no_activity == 1) {
																		...
																		foreach($arr_clnt_for_rr as $k=>$v) {
																			if ($k != '' AND (get_previous_yr_data($k)>0 OR ($arr_ytd_comm[$k]+$arr_ytd_check[$k])> 0) ) {
						...
						$data_to_html_file .= '
																	<tr class ="'.$class_row.'" bgcolor="'.$bgcolor.'" >
																		<td><font face="Arial" size="-4">&nbsp;'.look_up_client($k).'</font></td>
																		<td>&nbsp;&nbsp;<font face="Arial" size="1">'.$str_rep_num.'</font></td>
	...
	$file_name_prefix = substr(md5(rand(0,9999)),0,6);
