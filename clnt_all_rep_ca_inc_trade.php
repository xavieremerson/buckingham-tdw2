<?						
			...
			//echo "passed symbol = ".$show_symbol."<br>";
...
?>
      ...
      -->			
			...
			while($row_trades = mysql_fetch_array($result_trades))
			{
				...
				echo "// processing ".$row_trades["trad_symbol"]."\n";
				
				if (in_array($row_trades["trad_symbol"],$arr_final_symbols) AND $row_trades["trad_advisor_code"]!='BUCK') {
