...
tsp(100,"Trader (".$userfullname.") : CLIENT ACTIVITY");
?>
				<!-- START TABLE 3 -->
					<table width="100%" cellpadding="1", cellspacing="0" bgcolor="#CCCCCC">
													...
													<tr>
														...
														<form name="clnt_activity" id="idclnt_activity" action="" method="post">
															<tr>
																...
																<?
																$query_sel_client = "SELECT a.comm_advisor_code, max( a.comm_advisor_name ) as comm_advisor_name 
																											FROM rep_comm_rr_level_a a, int_clnt_clients b, Users c
																											WHERE comm_advisor_code NOT LIKE '&%'
																											AND a.comm_advisor_code = b.clnt_code
																											AND b.clnt_trader = c.Initials
																											AND c.ID = '".$user_id."'
																											GROUP BY a.comm_advisor_code
																											ORDER BY a.comm_advisor_name";
																...
																<?
																$query_sel_symbol = "SELECT DISTINCT(a.trad_symbol)
																...
																<td width="100"><a href="trdr_comm_container.php"><img src="images/lf_v1/clnt_commissions.png" border="0"></a></td>
																<td>&nbsp;</td>
														</tr>
														</form>															
														</table>
						...
						<tr id="pbd"> <!--  style="display=none; visibility=hidden" -->
							<td>
								<?
								include('rep_trdr_ca_inc_trade.php');
								?>
							</td>
						</tr>
						</table>
