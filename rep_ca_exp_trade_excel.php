...
$output_filename = "activity_".substr(md5(rand(1000000000,9999999999)),0,1).".xls";
...
//This was causing problems for some users (Ina Miller reported that it was showing as text)
