<?
  		...
  		//CAPTURE SUBTOTAL ROW IN ARRAY TO GET GRAND TOTAL
			...
			//SECTION 2 START
								...
								$wks->write($count_row_xls, 3, "TRADERS", $format_title_2);
									$count_row_xls = $count_row_xls + 1;
									$hold_count_row_xls = $count_row_xls;
			...
			//SECTION 4 BEGIN
								...
								$wks->write($count_row_xls, 3, "SHARED", $format_title_2);
									$count_row_xls = $count_row_xls + 1;
									$hold_count_row_xls = $count_row_xls;
			...
			//PUT SUBTOTAL
			$wks->writeFormula($count_row_xls, 5, "=sum(".$arr_xl_cols[5].$hold_count_row_xls_new_3.":".$arr_xl_cols[5].($count_row_xls).")", $format_currency_2);
			$wks->writeFormula($count_row_xls, 6, "=sum(".$arr_xl_cols[6].$hold_count_row_xls_new_3.":".$arr_xl_cols[6].($count_row_xls).")", $format_currency_2);
			$wks->writeFormula($count_row_xls, 8, "=sum(".$arr_xl_cols[8].$hold_count_row_xls_new_3.":".$arr_xl_cols[8].($count_row_xls).")", $format_currency_2);

			//CAPTURE ROW IN ARRAY
			$arr_subtotal_row[] = $count_row_xls;
			
			$count_row_xls = $count_row_xls + 2;
			$hold_count_row_xls_new_4 = $count_row_xls;
			...
			$wks->printArea(0,0,$hold_count_row_xls_new_3+2,11);
			$wks->fitToPages(1,1);

			//echo "Print Area is ".($hold_count_row_xls_new_3+2)."11";
