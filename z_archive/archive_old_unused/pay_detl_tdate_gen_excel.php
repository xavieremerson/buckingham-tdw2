...
echo "<font color='red'>Module in development phase!</font><br>";
...
include('pay_detl_tdate_functions.php');
...
include('pay_detl_tdate_gen_excel_format.php');

    //============================================================================================			

			//GETTING PRIMARY REP. DATA FROM TRADES
    ...
    //============================================================================================			
			...
			//start main
					...
					if ($row_trades["trad_rr"] == '001') {
					   //do nothing
							...
							include('pay_detl_tdate_gen_excel_header.php');
						  ...
						  //Now get the shared reps for the primary rep
							...
							$query_reps_shared = "SELECT a.srep_rrnum 
																			from sls_sales_reps a,
																			mry_comm_rr_trades b 
																			WHERE b.trad_trade_date BETWEEN '".$brk_start_date."' AND '".$brk_end_date."'
			...
			include('pay_detl_tdate_gen_excel_more.php');
