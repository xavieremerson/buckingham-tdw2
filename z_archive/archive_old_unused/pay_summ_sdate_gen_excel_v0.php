			...
			//start main
					...
					if ($row_trades["trad_rr"] == '000') {
					   //do nothing
							...
							$wks->writeNumber($count_row_global, 6, $row_trades["quantity"],$format_currency_4);
