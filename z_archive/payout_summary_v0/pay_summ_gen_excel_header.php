<?
					...
					$wks->mergeCells(1,13,1,17);
					
					$wks->write(1, 19, $brk_month." ".$brk_year." Gross Payout", $format_title_2);
					$wks->mergeCells(1,19,1,22);
					...
					$wks->write(2, 14, "TW", $format_title_3);
					$wks->write(2, 15, "Non Payout", $format_title_3);
					$wks->write(2, 16, "Other", $format_title_3);
					$wks->write(2, 17, "FN".chr(10)."#", $format_title_3);
					$wks->write(2, 19, "Sole", $format_title_4);
					$wks->write(2, 20, "Shared", $format_title_4);
					$wks->write(2, 21, "Total", $format_title_4);
					$wks->write(2, 22, "Monthly Draw", $format_title_4);
					$wks->write(2, 23, "Overage", $format_title_4);
					$wks->write(2, 24, "Hold", $format_title_4);
					$wks->write(2, 25, "Payout", $format_title_4);
					$wks->write(2, 26, "Lastname", $format_title_4);
?>