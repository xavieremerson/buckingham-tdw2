													...
													while($row_level_a_shared_reps_adv = mysql_fetch_array($result_level_a_shared_reps_adv))
													{
														...
														if ($level_a_shrd_count % 2) { 
															...
															if (in_array($comm_advisor_shrd_code,$arr_relevant_shared_clients)) {
																						...
																						?>
																							<tr class="<?=$class_row?>">
																								<td valign="middle">&nbsp;&nbsp;<a href='#'><img src="images/t12m_s.png" border="0" onclick="CreateWnd('chart_t12m.php?clnt=<?=$comm_advisor_shrd_code?>', 620, 330, false);"></a>&nbsp;&nbsp;<?=$show_shrd_advisor_name?></td>
																								<td>&nbsp;&nbsp;<?=$show_shrd_rr?></td>
