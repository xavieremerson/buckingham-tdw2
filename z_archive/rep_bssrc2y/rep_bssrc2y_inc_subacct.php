...
?>
	...
	<tr class="<?=$class_row?>"> 
		<td width="343" align="left">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?=$show_account_name?>&nbsp;&nbsp;</td>
		<td width="102" align="right"><?=$show_previous_day_comm_sa?>&nbsp; &nbsp; &nbsp;&nbsp;</td>
		<td width="104" align="right"><?=$show_mtd_sa?>&nbsp; &nbsp; &nbsp;&nbsp;</td>
		<td width="104">&nbsp;</td>
		<td width="102"align="right"><?=$show_qtd_sa?>&nbsp; &nbsp; &nbsp;&nbsp;</td>
		<td width="104">&nbsp;</td>
		<td width="104" align="right"><?=$show_ytd_sa?>&nbsp; &nbsp; &nbsp;&nbsp;</td>
		<td width="100">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
<?
