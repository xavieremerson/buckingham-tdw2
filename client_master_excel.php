...
if ($req_ajax) {
	...
	$query_clients = "SELECT * from int_clnt_clients where clnt_isactive != 0 order by clnt_name LIMIT 50";
	$query_money = "SELECT clnt_code from int_clnt_clients where clnt_isactive != 0 order by clnt_name LIMIT 50";
}
...
$str = '<table id="sort_this" width="100%"  border="1" cellspacing="1" cellpadding="1"><!-- class="sortable" preserve_style="cell"-->
						<thead>
							...
							<td><strong>Large Trdr. ID</strong></td>
									...
									if ($val_tier == $valcriteria) {
													if ($row["clnt_isactive"] != 0) {
														$str = '<tr>
															...
															'.$str_tier_show.'
															<td>'.$row["clnt_address_line_1"].'</td>
															<td>'.$row["clnt_address_line_2"].'</td>
															<td>'.$row["clnt_address_city"].'</td>
															<td>'.$row["clnt_address_state"].'</td>
															<td>'.$row["clnt_address_postal_code"].'</td>
