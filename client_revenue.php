...
///////////////////////////////////////////////  START OF MANAGE SECTION  ////////////////////////////////////////////////////////////
    ...
    if ($mode == 'm') {
    ?>
    <td width="200">&#9658;<a class="ilt" href="client_revenue_excel.php?mode=m&filter_rep=<?=$filter_rep?>&filter_tier=<?=$filter_tier?>" target="_blank">Export to Excel</a></td>
		<?
    } else {
		?>
    <td width="200">&#9658;<a class="ilt" href="client_revenue_excel.php?mode=r&user_initials=<?=$user_initials?>" target="_blank">Export to Excel</a></td>
    <?
		}
		if ($mode == 'm') {
		?>
            ...
            if ($filter_tier && $filter_tier != "") {
								...
								echo	"<tr " . $rowclass . ">".
              						...
              						"<td>".$row["clnt_address_state"] ."</td>".
													"<td>&nbsp;".$row["clnt_rr1"]."</td>". 
													"<td valign='middle' nowrap='nowrap'><a href='#'><img src='images/t12m_s.png' border='0' onclick='CreateWnd(\"chart_mult_years.php?clnt=" .$row["clnt_code"]."\", 620, 330, false);'></a></td>" .
