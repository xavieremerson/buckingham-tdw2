				...
				<td>
					<table width="100%"  border="0" cellspacing="0" cellpadding="1">
						...
						$str_sql_select = "SELECT 
												          ...
												          trad_advisor_code,trad_advisor_name,trad_account_name,trad_account_number,trad_symbol,
																	trad_buy_sell,trad_quantity,trade_price,trad_commission,trad_cents_per_share 
