...
<table width="100%" cellpadding="1", cellspacing="0" bgcolor="#CCCCCC">
	<tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#FFFFFF">				
			<tr>
					<td align="left"><a class="links_temp" href="rep_all_trdr_ca_exp_trade_excel.php?xl='.$passtoexcel.'" target="_blank">GET TO EXCEL</a>&nbsp;&nbsp;&nbsp;<font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#666666"><strong>'.$string_heading.'</strong>&nbsp;&nbsp;</font></td>
					<td>&nbsp;</td>
				</tr>
		</table>';
?>
...
var dt = new Array()
			...
			while($row_trades = mysql_fetch_array($result_trades))
			{
				...
				$running_trad_quantity_total = $running_trad_quantity_total + $row_trades["for_sum_trad_quantity"];
...
?>		
				...
				<tfoot>
					<tr bgcolor="#CCCCCC" class="display_totals">
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align="right"><?=number_format($running_trad_quantity_total,0,'.',',')?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align="right">&nbsp;</td>
						<td align="right"><?=number_format($running_trad_commission_total,2,'.',',')?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align="right"><?=number_format($running_trad_commission_total/$running_trad_quantity_total,3,'.',',')?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				</tfoot>
				</table>
