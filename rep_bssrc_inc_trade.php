	...
	$query_trades = "SELECT 
											...
											max(trade_price) as trade_price,
										...
										GROUP BY trad_advisor_code, trad_symbol, trad_buy_sell
										ORDER BY trad_advisor_name, trad_symbol, trad_buy_sell";
	...
	?>
				...
				?>
					...
					<tr bgcolor="#333333">
						<td align="left" class="tblheadx"><strong>&nbsp;Trades (Primary Rep.): <?=format_date_ymd_to_mdy($trade_date_to_process)?></strong></td>
					</tr>
					</table>
					<table width="100%" cellpadding="1", cellspacing="0" bgcolor="#CCCCCC">
						<tr>
