...
$sql = "SELECT * from `nfs_trades` where trad_branch = 'PDY' and trad_trade_date between '2010-01-01' and '2010-03-31'"; // limit 1, 100
...
while ($row = mysql_fetch_array($result)) {
      ...
      //========================================================================================================
			...
			//echo "Quantity : ".$qty_nfs." for ".substr($row["trad_short_name"],0,4)."\n";
