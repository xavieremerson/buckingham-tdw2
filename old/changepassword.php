 ...
 ?>
	<form action="<?=$php_self?>" method="post" enctype="multipart/form-data" name="passreset" target="_self">
		...
		?>
			...
			<tr> 
				<td colspan="2" align="center"><input class="Submit" name="submit" type="submit" value="Change Password">&nbsp;&nbsp;<input class="Submit" name="close" type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Close&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" onClick="javascript:window.close()"></td>
			</tr>
		</table>
	</form>
<? 	
