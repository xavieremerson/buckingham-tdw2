...
//If trades do not exist, there has been one or more errors in the import/upload of trades
	...
	if ($numtrades_val > 0) {						
						...
						<td align="left" valign="top">
							...
							//syntax  sys_mail(to, subject, body, heading: this goes in the body too)
							...
							//sys_mail(email_report_to(),"Trades Report for (".$trade_date_to_process.")", $reportmailbody, "Trades Report for Date (".$trade_date_to_process.") Generated on ".date("D, m/d/Y h:i a"));
						
							//Sending link of Trades Report file via email
							echo "<BR>Creating Trades Report file...<BR>";
							create_trade_report("pprasad@tocqville.com","Trades Report for (".$trade_date_to_process.")", $reportmailbody, "Trades Report for Date (".$trade_date_to_process.") Generated on ".date("D, m/d/Y h:i a"));
