			...
			$htmlfilebodydata .= '<tr> 
					...
					//**************************************************************************************
						...
						$htmlfiledata .= rep_footer_emp_trades();
										...
										echo "FILE ".$str_filename." WRITTEN!<BR>and PDF Created!<BR>";
										...
										html_emails('prasad_pravin@yahoo.com', $mailsubject, $mailbodysubinfo, $emailheading, $fileattach, $control_id); 
