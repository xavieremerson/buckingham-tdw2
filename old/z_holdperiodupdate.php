...
echo $tdate1. "<br><br>";
$query_update = "UPDATE Trades_m SET trdm_trade_date = '".$tdate1."', trdm_settle_date = '".$sdate1."' WHERE trdm_auto_id = '78970' OR trdm_auto_id = '78296' OR trdm_auto_id = '79651' OR trdm_auto_id = '79645'";
...
$query_update2 = "UPDATE Trades_m SET trdm_trade_date = '".$tdate2."', trdm_settle_date = '".$sdate2."'  WHERE trdm_auto_id = '77113'";
echo $query_update2. "<br><br>";																																				
$result_update2 = mysql_query($query_update2) or die(mysql_error());

$query_update3 = "UPDATE Trades_m SET trdm_trade_date = '".$tdate3."', trdm_settle_date = '".$sdate3."'  WHERE trdm_auto_id = '77043'";
echo $query_update3. "<br><br>";																																				
$result_update3 = mysql_query($query_update3) or die(mysql_error());

$query_update4 = "UPDATE Trades_m SET trdm_trade_date = '".$tdate4."', trdm_settle_date = '".$sdate4."'  WHERE trdm_auto_id = '72066'";
echo $query_update4. "<br><br>";																																				
$result_update4 = mysql_query($query_update4) or die(mysql_error());

$query_update5 = "UPDATE Trades_m SET trdm_trade_date = '".$tdate5."', trdm_settle_date = '".$sdate5."'  WHERE trdm_auto_id = '72065'";
