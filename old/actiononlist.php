...
Are you sure you want to delete account: (<?=$Name?>)?<br><br><center><a href="actiononlist.php?Action=DeleteSingleY&Name=<?=$Name?>&ID=<?=$ID?>" class="links12">Yes</a> &nbsp;&nbsp;:&nbsp;&nbsp; <a href="JavaScript:history.back()" class="links12">No</a></center><BR><BR>
</td></tr></table>
<?php
