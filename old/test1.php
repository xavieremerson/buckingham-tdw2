...
<?
			...
			else
			{
				...
				$emailheading = "CompSys Registration and Password";
				...
				$mailbody    .= 'Click on the link to launch <a href="http://www.centersys.com/demo/compsys/">'.$_app_name.'</a> <Br><br><br>From: </font>';
