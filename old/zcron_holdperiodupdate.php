...
echo $tdate1. "<br><br>";
$query_update = "UPDATE Trades_m SET trdm_trade_date = '".$tdate1."', trdm_settle_date = '".$sdate1."' WHERE trdm_auto_id = '30092' OR trdm_auto_id = '30069' OR trdm_auto_id = '30034' OR trdm_auto_id = '14187'";
