  ...
  */
  ...
  function fetch($raw_xml) {
    ...
    xml_parser_set_option($this->parser, XML_OPTION_TARGET_ENCODING, "UTF-8");
		...
		//xdebug("LENGTH OF XML",strlen($raw_xml));
		
		if (strlen($raw_xml) == 0) {
		   echo '<font color="red">*</font>'; //'<h3><font color="red">FAILED GETTING RESPONSE FROM MAIL SERVER</font></h3>';
			 $this->prob++;
			 //exit;
		} else {
		   echo '<font color="green">*</font>'; //'<h3><font color="green">SUCCESS</font></h3>';
			 $this->noprob++;
		}
						
		//xdebug("RAW XML",$raw_xml);
