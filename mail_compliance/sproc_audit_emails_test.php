...
$trade_date_to_process = '2010-04-26';
...
$exchange_password = "Trade!23";   // tdw/Buck123  IP=74
							...
							//$trade_date_to_process = '2010-04-26'; //remember date should be changed in function also. above.
							//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
							$trade_date_to_process = previous_business_day();
							//$trade_date_to_process ='2008-01-28';
							//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
							...
							foreach($x->data->A_MULTISTATUS[0]->A_RESPONSE as $idx=>$item) { 
									...
									if (substr($item->A_PROPSTAT[0]->A_PROP[0]->D_DATERECEIVED[0]->_text,0,10) == $trade_date_to_process) { //$item->A_PROPSTAT[0]->A_PROP[0]->D_DATERECEIVED[0]->_text
										...
										echo "<pre>".$item->A_PROPSTAT[0]->A_PROP[0]->D_DATERECEIVED[0]->_text . "\n</pre>";
										$count_qn = $count_qn + 1;
							...
							echo "# of QuickNote items = ".$count_qn."<br>"; 
							...
							//set all data in the table to inactive for this trade date and then insert this record.
										...
										if (($count_iu+$count_qn+$count_rd)==$count_rd_all) {
											...
											echo "Totals are NOT correct and there are exceptions";
											$is_ok = 0;
										}
										
										echo "<br>Processed : ".$trade_date_to_process."";
										echo "<br><br>";
