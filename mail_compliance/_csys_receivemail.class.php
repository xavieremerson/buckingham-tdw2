<?php
// Main ReceiveMail Class File - Version 1.1 (02-06-2011)
/*
 * File: _csys_receivemail.class.php
 * Description: Receive mail With Attachment
 * Version: 1.4
 */
...
class receiveMail
{
	...
	function moveMails($mid) // Delete That Mail
	{
		if(!$this->marubox)
			return false;
	
		//imap_mail_move($this->marubox,$mid,"FTR_ARCHIVE");
	}
