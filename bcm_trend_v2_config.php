...
function monthly_report() {
	...
	var url = 'http://192.168.20.63/tdw/bcm_trend_v2_privol_ajx.php';
...
<script language="javascript">
	function run_test() {
		...
		var url = 'http://192.168.20.63/tdw/bcm_trend_v2_privol_apply_ajx.php';
		var pars = 'mod_request=runtest';
		pars = pars + "&" + $("frm_test").serialize();
		pars = pars + '&xrand='+ Math.random();
		//alert(pars);
		//return false;
		//$("err_data").innerHTML = "bcm_trend_v2_test_ajx.php?"+pars;
		//return false;  
