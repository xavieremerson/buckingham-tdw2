...
function process_excel () {
  ...
  var url = 'http://192.168.20.63/tdw/rep_client_master_excel.php';
  var pars = 'user_id=<?=$user_id?>';
  var pars = pars + '&user_initials=<?=$user_initials?>';
  var pars = pars + '&role=<?=$role?>';
...
function getClientData()
{
  ...
  var url = 'http://192.168.20.63/tdw/rep_client_master_ajx.php';
  var pars = 'user_id=<?=$user_id?>';
  var pars = pars + '&user_initials=<?=$user_initials?>';
  var pars = pars + '&role=<?=$role?>';
...
<?
//if ($user_id != 93 && $user_id != 253 && $user_id != 79 && $user_id != 289 ) {
  
/*<table><tr><td>MODULE TAKEN OFFLINE FOR MAINTENANCE.<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></td></tr></table>	
exit;
}*/
...
<table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0"> 
  <tr>
    <td width="5">&nbsp;</td>
    <td align="left"><a class="links11" style="cursor:pointer;" onclick="showPopWin('client_master_add.php?user_id=<?=$user_id?>', 470, 330, null);"><img src="images/plus14.png" border="0" /> Add Prospect</a></td>
    ...
    <!----><iframe src="rep_client_master_ajx.php?proc_user=<?=$user_id?>&user_initials=<?=$user_initials?>" class="iframestyle" id="content_area" scrolling="auto" width="100%" style="border-width:thin; margin-top:0px; margin-left:0px;" onload="resize_iframe()"></iframe>
