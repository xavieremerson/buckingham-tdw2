...
$string = "\"Trade Date\",\"ADVISOR / CLIENT\",\"RR #\",\"Symbol\",\"B/S\",\"Shares\",\"Price\"".chr(13); 
fputs ($fp, $string);
...
$running_trad_commission_total = 0;
	...
	while ( $row_trades = mysql_fetch_array($result_trades) ) {
				...
				$string = "\"".$show_trad_trade_date."\",\"".$show_trad_advisor_name."\",\"".$show_trad_rr."\",\"".$show_trad_symbol."\",\"".$show_trad_buy_sell."\",\"".$show_trad_quantity."\",\"".$show_trade_price."\",\"".''."\",\"".''."\",\"".''."\"".chr(13); 
