					...
					<table class="tbl_xl" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td class="tdx">
								<table width="100%">
									<tr>
										<td><input type="text" style="border: 0px; font-size:10px" name="<?=$i."|".$j?>" id="<?=$i."|".$j?>" value="<?=$pop_array[$i."|".$j]?>" size="3" maxlength="3" onchange="xlrecalc('<?=$i."|".$j?>')" onkeyup="return xlmove(event, '<?=$i."|".$j?>')" onfocus="selitem('<?=$i."|".$j?>')"/><!--<a class="num_1">% </a>--></td>
										<td class="num_1" nowrap="nowrap" id="curnum|<?=$i."|".$j?>"></td>
									</tr>
								</table>
							</td>		
